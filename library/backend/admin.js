...
function addItem(table,title, author, isbn, qty){
    ...
    buttonCell.in = document.createElement("button")

    bookRow.append(titleData, authorData, isbnData, qtyData, buttonCell)
    
    window.localStorage.setItem("title", title);
    window.localStorage.setItem("author", authorData)
    window.localStorage.setItem("ISBN", isbnData)
